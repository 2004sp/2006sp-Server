...
extends TickTask {
    ...
    public BarbarianVillageHelmetShopTradeTickTask(BarbarianVillageHelmetShopBotTask barbarianVillageHelmetShopBotTask, int value2, Player player, ItemStack itemStack) {
        super(2);
        this.player = player;
