...
extends BotTaskDefinition {
    ...
    public CatherbyArcheryShopShortbowBotTask(int value2) {
    ...
    public final void startCustomTaskAction(Player player) {
        ...
        World.getTaskScheduler().schedule(new CatherbyArcheryShopShortbowTradeTickTask(this, 2, (Player)player, itemStack));
    }
