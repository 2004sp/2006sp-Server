...
extends TickTask {
    ...
    public CatherbyArcheryShopShortbowTradeTickTask(CatherbyArcheryShopShortbowBotTask catherbyArcheryShopShortbowBotTask, int value2, Player player, ItemStack itemStack) {
        super(2);
        this.player = player;
