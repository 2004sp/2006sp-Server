...
extends BotTaskDefinition {
    ...
    public ChampionsGuildPlatebodyShopBotTask(int value2) {
    ...
    public final void startCustomTaskAction(Player player) {
        ...
        World.getTaskScheduler().schedule(new ChampionsGuildPlatebodyShopTradeTickTask(this, 2, (Player)player, itemStack));
    }
