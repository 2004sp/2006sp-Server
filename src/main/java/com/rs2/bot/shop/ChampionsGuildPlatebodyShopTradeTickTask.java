...
extends TickTask {
    ...
    public ChampionsGuildPlatebodyShopTradeTickTask(ChampionsGuildPlatebodyShopBotTask championsGuildPlatebodyShopBotTask, int value2, Player player, ItemStack itemStack) {
        super(2);
        this.player = player;
