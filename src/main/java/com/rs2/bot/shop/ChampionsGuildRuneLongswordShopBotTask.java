...
extends BotTaskDefinition {
    ...
    public ChampionsGuildRuneLongswordShopBotTask(int value2) {
    ...
    public final void startCustomTaskAction(Player player) {
        ...
        World.getTaskScheduler().schedule(new ChampionsGuildRuneLongswordShopTradeTickTask(this, 2, (Player)player, itemStack));
    }
