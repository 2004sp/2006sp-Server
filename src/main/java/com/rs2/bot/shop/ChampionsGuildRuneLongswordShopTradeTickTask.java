...
extends TickTask {
    ...
    public ChampionsGuildRuneLongswordShopTradeTickTask(ChampionsGuildRuneLongswordShopBotTask championsGuildRuneLongswordShopBotTask, int value2, Player player, ItemStack itemStack) {
        super(2);
        this.player = player;
