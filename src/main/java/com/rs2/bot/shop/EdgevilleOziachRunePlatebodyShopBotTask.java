...
extends BotTaskDefinition {
    ...
    public EdgevilleOziachRunePlatebodyShopBotTask(int value2) {
    ...
    public final void startCustomTaskAction(Player player) {
        ...
        World.getTaskScheduler().schedule(new EdgevilleOziachRunePlatebodyShopTradeTickTask(this, 2, (Player)player, itemStack));
    }
