...
extends TickTask {
    ...
    public EdgevilleOziachRunePlatebodyShopTradeTickTask(EdgevilleOziachRunePlatebodyShopBotTask edgevilleOziachRunePlatebodyShopBotTask, int value2, Player player, ItemStack itemStack) {
        super(2);
        this.player = player;
