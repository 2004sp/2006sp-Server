...
extends BotTaskDefinition {
    ...
    public FaladorChainbodyShopBotTask(int value2) {
    ...
    public final void startCustomTaskAction(Player player) {
        ...
        World.getTaskScheduler().schedule(new FaladorChainbodyShopTradeTickTask(this, 2, (Player)player, itemStack));
    }
    ...
    public final void startWalkToTask(Player player) {
        int value = !GameplayHelper.isObjectDefinitionIdValid(11993) ? 1530 : 11993;
    ...
    public final void continueWalkToTask(Player player, int value3) {
        int value2 = !GameplayHelper.isObjectDefinitionIdValid(11993) ? 1530 : 11993;
        player.setAutoRetaliate(true);
    ...
    public final void advanceTaskRouteSegment(Player player, boolean enabled2) {
        int value;
        int value2 = value = !GameplayHelper.isObjectDefinitionIdValid(11993) ? 1530 : 11993;
