...
extends BotTaskDefinition {
    ...
    public PortSarimMagicShopChaosRuneBotTask(int value2) {
    ...
    public final void startCustomTaskAction(Player player) {
        ...
        World.getTaskScheduler().schedule(new PortSarimMagicShopChaosRuneTradeTickTask(this, 2, (Player)player, itemStack));
    }
