...
extends TickTask {
    ...
    public PortSarimMagicShopChaosRuneTradeTickTask(PortSarimMagicShopChaosRuneBotTask portSarimMagicShopChaosRuneBotTask, int value2, Player player, ItemStack itemStack) {
        super(2);
        this.player = player;
