...
extends BotTaskDefinition {
    ...
    public VarrockArcheryShopSteelArrowBotTask(int value2) {
    ...
    public final void startCustomTaskAction(Player player) {
        ...
        World.getTaskScheduler().schedule(new VarrockArcheryShopSteelArrowTradeTickTask(this, 2, (Player)player, itemStack));
    }
