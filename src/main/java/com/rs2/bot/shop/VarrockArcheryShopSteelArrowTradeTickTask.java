...
extends TickTask {
    ...
    public VarrockArcheryShopSteelArrowTradeTickTask(VarrockArcheryShopSteelArrowBotTask varrockArcheryShopSteelArrowBotTask, int value2, Player player, ItemStack itemStack) {
        super(2);
        this.player = player;
