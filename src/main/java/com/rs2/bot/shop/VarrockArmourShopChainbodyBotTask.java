...
extends BotTaskDefinition {
    ...
    public VarrockArmourShopChainbodyBotTask(int value2) {
    ...
    public final void startCustomTaskAction(Player player) {
        ...
        World.getTaskScheduler().schedule(new VarrockArmourShopChainbodyTradeTickTask(this, 2, (Player)player, itemStack));
    }
