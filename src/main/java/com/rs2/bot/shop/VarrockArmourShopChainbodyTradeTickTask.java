...
extends TickTask {
    ...
    public VarrockArmourShopChainbodyTradeTickTask(VarrockArmourShopChainbodyBotTask varrockArmourShopChainbodyBotTask, int value2, Player player, ItemStack itemStack) {
        super(2);
        this.player = player;
