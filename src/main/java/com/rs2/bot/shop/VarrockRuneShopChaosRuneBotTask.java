...
extends BotTaskDefinition {
    ...
    public VarrockRuneShopChaosRuneBotTask(int value2) {
    ...
    public final void startCustomTaskAction(Player player) {
        ...
        World.getTaskScheduler().schedule(new VarrockRuneShopChaosRuneTradeTickTask(this, 2, (Player)player, itemStack));
    }
