...
extends TickTask {
    ...
    public VarrockRuneShopChaosRuneTradeTickTask(VarrockRuneShopChaosRuneBotTask varrockRuneShopChaosRuneBotTask, int value2, Player player, ItemStack itemStack) {
        super(2);
        this.player = player;
