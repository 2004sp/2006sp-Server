...
extends BotTaskDefinition {
    ...
    public VarrockStaffShopFireStaffBotTask(int value2) {
    ...
    public final void startCustomTaskAction(Player player) {
        ...
        World.getTaskScheduler().schedule(new VarrockStaffShopFireStaffTradeTickTask(this, 2, (Player)player, itemStack));
    }
