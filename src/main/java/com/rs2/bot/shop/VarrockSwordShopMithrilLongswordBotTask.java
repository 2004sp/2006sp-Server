...
extends BotTaskDefinition {
    ...
    public VarrockSwordShopMithrilLongswordBotTask(int value2) {
    ...
    public final void startCustomTaskAction(Player player) {
        ...
        World.getTaskScheduler().schedule(new VarrockSwordShopMithrilLongswordTradeTickTask(this, 2, (Player)player, itemStack));
    }
