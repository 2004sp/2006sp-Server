...
extends TickTask {
    ...
    public VarrockSwordShopMithrilLongswordTradeTickTask(VarrockSwordShopMithrilLongswordBotTask varrockSwordShopMithrilLongswordBotTask, int value2, Player player, ItemStack itemStack) {
        super(2);
        this.player = player;
