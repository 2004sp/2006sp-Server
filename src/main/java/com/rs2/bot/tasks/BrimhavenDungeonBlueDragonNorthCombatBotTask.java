...
extends BotTaskDefinition {
    ...
    public BrimhavenDungeonBlueDragonNorthCombatBotTask(int value3) {
    ...
    public final void prepareTaskInventory(Player player) {
        ...
        Object value = new ItemStack[]{new ItemStack(995, 875), new ItemStack(1359), new ItemStack(player.botFoodItemId, 20)};
        ...
        player.getInventoryManager().addItem(((ItemStack[])value)[2]);
        value = player;
