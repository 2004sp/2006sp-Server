...
extends BotTaskDefinition {
    ...
    public LumbridgeWestChickenCombatBotTask(int value3) {
    ...
    public final ArrayList getRequiredItems(Player player) {
        ...
        while (index < length) {
            ...
            while (index2 < length2) {
                ...
                if (player.ownsItemAmount(value, 5)) {
                    initialValue = value;
                    break;
                }
                ++index2;
        ...
        arrayList.add(new ItemStack(initialValue, 5));
    ...
    public final void advanceTaskRouteSegment(Player player, boolean enabled2) {
        int value;
        int value2 = value = !GameplayHelper.isObjectDefinitionIdValid(12987) ? 1553 : 12987;
