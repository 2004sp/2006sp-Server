...
extends TickTask {
    ...
    public NorthMossGiantDungeonEntryTickTask(EdgevilleDungeonNorthMossGiantCombatBotTask edgevilleDungeonNorthMossGiantCombatBotTask, int value2, Player player) {
        super(3);
        this.player = player;
    }
