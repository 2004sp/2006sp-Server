...
extends BotTaskDefinition {
    ...
    public SeersMapleWoodcuttingBotTask(int value3) {
    ...
    public final void configureTaskInteractionTargets(Player player) {
        ...
        int[] integerValues = TreeDefinition.collectObjectIds(new TreeDefinition[]{TreeDefinition.MAPLE});
    ...
    public final void prepareTaskCombatLoadout(Player player) {
        ...
        if ((value = value - value / 5 + GameUtil.randomInt(value2)) < 45) {
            value = 45;
        }
