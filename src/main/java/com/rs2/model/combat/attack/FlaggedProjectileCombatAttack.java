...
extends BaseCombatAttack {
    ...
    public FlaggedProjectileCombatAttack(Entity entity, Entity entity2, AttackXpMode attackXpMode, CombatType combatType, ProjectileTiming projectileTiming, int projectileId, boolean alwaysHits, int maxHit, boolean deferProtectionPrayerReduction, int hitDelay, GraphicEffect graphicEffect, CombatEffect combatEffect, int animationId, int attackDelay, GraphicEffect graphicEffect2) {
